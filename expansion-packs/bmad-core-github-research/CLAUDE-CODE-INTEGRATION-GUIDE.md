# Claude Code Integration Guide for BMAD-Core-GitHub-Research

## Overview

This guide explains how to use BMAD-Core-GitHub-Research with **Claude Code's native GitHub integration** (`@github #issue`), enabling you to leverage both BMAD's rich story preparation workflow AND Claude Code's native issue handling.
...
expansion-packs/bmad-core-github-research/issue-templates/detailed-story.yml
...
# Copy the template
cp expansion-packs/bmad-core-github-research/issue-templates/detailed-story.yml \
