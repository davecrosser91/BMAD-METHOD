...
Create `.bmad-core-github-research/scripts/update-project-status.sh`:
...
github-integration:
  on-story-start:
    - command: .bmad-core-github-research/scripts/update-project-status.sh {issue-number} "In Progress"
    - fallback: gh issue edit {issue-number} --add-label "status:doing"
  on-story-complete:
    - command: .bmad-core-github-research/scripts/update-project-status.sh {issue-number} "In Review"
...
github-integration:
  on-qa-pass:
    - command: .bmad-core-github-research/scripts/update-project-status.sh {issue-number} "Done"
