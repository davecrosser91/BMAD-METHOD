...
./expansion-packs/bmad-core-github-research/scripts/update-project-status.sh $ISSUE "In Progress"
```
...
```bash
./expansion-packs/bmad-core-github-research/scripts/update-project-status.sh $ISSUE "In Review"
```
...
```bash
./expansion-packs/bmad-core-github-research/scripts/update-project-status.sh $ISSUE "Done"
```
...
```bash
./expansion-packs/bmad-core-github-research/scripts/update-project-status.sh $ISSUE "Backlog"
```
...
```bash
./expansion-packs/bmad-core-github-research/scripts/update-project-status.sh $ISSUE "Todo"
```
...
```bash
chmod +x ./expansion-packs/bmad-core-github-research/scripts/init-github-project.sh
...
```bash
chmod +x ./expansion-packs/bmad-core-github-research/scripts/setup-labels.sh
./expansion-packs/bmad-core-github-research/scripts/setup-labels.sh
```
...
./expansion-packs/bmad-core-github-research/scripts/update-project-status.sh 123 "In Progress"
```
...
For detailed analysis: `expansion-packs/bmad-core-github-research/PROJECTS-VS-LABELS-ANALYSIS.md`
