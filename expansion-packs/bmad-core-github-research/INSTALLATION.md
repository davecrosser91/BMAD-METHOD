# BMAD-Core-GitHub-Research Installation Guide

## Overview

This guide explains how to install and use the **bmad-core-github-research** expansion pack, which provides a research/experimental GitHub-native implementation of the BMAD Method using GitHub Issues, Milestones, Labels, and Pull Requests for task management.
...
# Install with bmad-core-github-research expansion pack
npx @dkreuzer/bmad-method-ai-research install -e bmad-core-github-research
```

The installer will:

- ✅ Install the bmad-core framework (if not already installed)
- ✅ Install the bmad-core-github-research expansion pack
- ✅ Set up the folder structure (`.bmad-core-github-research/`, `docs/`, etc.)
...
chmod +x .bmad-core/expansion-packs/bmad-core-github-research/scripts/setup-labels.sh

# Run the setup script
.bmad-core/expansion-packs/bmad-core-github-research/scripts/setup-labels.sh
```
...
cp .bmad-core/expansion-packs/bmad-core-github-research/workflows/automated-qa-review.yml .github/workflows/
...
ls .bmad-core/expansion-packs/bmad-core-github-research/agents/
...
1. **Activate the Analyst Agent**
   ...
   ```
   Please act as the Analyst agent from .bmad-core/expansion-packs/bmad-core-github-research/agents/analyst.md
   ```
...
3. **Switch to PM Agent**
   ...
   ```
   Please switch to the PM agent from .bmad-core/expansion-packs/bmad-core-github-research/agents/pm.md
   ```
...
6. **Plan Your Sprint**
   ...
   ```
   Please switch to the Scrum Master agent from .bmad-core/expansion-packs/bmad-core-github-research/agents/sm.md
   ```
...
7. **Start Development**
   ...
   ```
   Please switch to the Developer agent from .bmad-core/expansion-packs/bmad-core-github-research/agents/dev.md
   ```
...
Edit `.bmad-core/expansion-packs/bmad-core-github-research/config.yaml` to customize:
...
→ Run `.bmad-core/expansion-packs/bmad-core-github-research/scripts/setup-labels.sh` manually.
...
→ Make scripts executable: `chmod +x .bmad-core/expansion-packs/bmad-core-github-research/scripts/*.sh`
