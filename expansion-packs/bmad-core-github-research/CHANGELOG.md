...
All notable changes to BMAD-Core-GitHub-Research will be documented in this file.
...
**BMAD-Core-GitHub-Research v2.5.1** - Research/experimental BMAD Method implementation using GitHub as the backbone.
...
**Note:** This is a research/experimental version of BMAD-Core-GitHub. Feedback and contributions are welcome!
