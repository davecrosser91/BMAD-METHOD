...
# - Zotero: Previously saved papers from personal library (if MCP configured)
...
**CRITICAL: All outputs are MARKDOWN files saved locally**

After completion, save to `docs/research/deep-research-[topic]-[date]/`:

```
docs/research/deep-research-[topic]-[date]/
├── deep-research-report.md          # Full comprehensive report (markdown)
├── executive-summary.md             # 1-page summary (markdown)
├── bibliography.md                  # Complete source list with ratings (markdown)
├── methodology.md                   # Research process documentation (markdown)
├── pattern-analysis.md              # Cross-cutting themes and insights (markdown)
├── knowledge-gaps.md                # Identified gaps and future directions (markdown)
└── process-log.md                   # Lessons learned and improvement notes (markdown)
```

**No external storage**: All files are markdown, version-controlled with git.
