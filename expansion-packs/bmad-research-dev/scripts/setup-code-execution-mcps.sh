...
if [ ! -d "$PACK_ROOT" ]; then
    print_error "BMAD Research-Dev pack not found at $PACK_ROOT"
...
See `../.bmad-research-dev/CODE-EXECUTION-MCP-ARCHITECTURE.md` for complete documentation.
EOF
...
echo "  ${BLUE}Architecture Guide:${NC} .bmad-research-dev/CODE-EXECUTION-MCP-ARCHITECTURE.md"
echo "  ${BLUE}Quick Start:${NC} .bmad-research-dev/QUICKSTART-CODE-EXECUTION.md"
